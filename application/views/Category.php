			...
			<div class="row content">
				...
				if ($products !== null) {
					for ($i = 0; $i < sizeof($products); $i++) {
						...
						echo "<img onclick=\"gotoPage('product/" . vn_to_str($product["name_product"] . "-" . substr("00000" . $product["id_product"], strlen("00000" . $product["id_product"]) - 5, 5)) . ".html')\" style=\"cursor:pointer\" alt=\"" . $product["id_product"] . "\" src=\"" . base_url() . "images/" . base_url() . "images/" . base_url() . "images/" . $product["DuongDan"] . "\"></div>";
