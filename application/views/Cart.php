							...
							<table class="table product-list">
								...
								<?php
									if (isset($carts) == false || sizeof($carts) == 0) {
										echo "<p class=\"error\">Giỏ hàng trống</p>";
									} else {
										for ($i = 0; $i < sizeof($carts); $i++) {
											...
											echo "<input type=\"number\" value=\"" . $product["count"] . "\" step=\"0.1\" min-value=\"0.5\" max-value=\"100\" class=\"text\" oninput=\"refreshTablePrice(this)\">";
											echo "</td>";
											echo "<td class=\"amount\">";
											echo number_format($product["price"]*$product["count"])."đ";
											echo "</td>";
											echo "<td class=\"\">";
											echo "<a onclick=\"removeItemCart(item)\" href=\"javascript:void(0)\">";
