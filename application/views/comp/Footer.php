                                    ...
                                    <div class="col-md-12 text-center text-lg-left">
                                        <div class="col-sm-12 col-md-12 col-xs-12 footer-static-title">
                                            <div class="col-sm-4 col-md-4" style="padding-right: 10px;">
                                                ...
                                                <div class="col-sm-12 col-md-12 col-xs-12 address-footer" style="font-size: 13px; padding-top: 2px;">YeuSach.com nhận đặt hàng trực tuyến và giao hàng tận nơi. KHÔNG hỗ trợ đặt mua và nhận hàng trực tiếp tại văn phòng cũng như tất cả Hệ Thống Yêu sách Bookstore trên toàn quốc.</div>
                                            </div>
                                            <div class="col-sm-4 col-md-4 col-xs-12" style="padding: 0px;">
                                                <div class="col-sm-12 col-md-12 col-xs-12" align="center" style="font-size: 14.5px; margin-bottom: 20px; margin-top: 10px; padding: 0px;">
                                                    <a target="_blank" href="javascript:void(0)" title="Facebook"> <img alt="Facebook" src="https://www.fahasa.com/skin/frontend/ma_vanese/fahasa/images/footer/Facebook-on.png">
                                                    </a>
                                                    <a target="_blank" href="javascript:void(0)" title="Instagram"> <img alt="Instagram" src="https://www.fahasa.com/skin/frontend/ma_vanese/fahasa/images//footer/Insta-on.png">
                                                    </a>
                                                    <a target="_blank" href="" title="Youtube"> <img alt="Youtube" src="https://www.fahasa.com/skin/frontend/ma_vanese/fahasa/images//footer/Youtube-on.png">
                                                    </a>
                                                    <a target="_blank" href="javascript:void(0)" title="Twitter"> <img alt="Twitter" src="https://www.fahasa.com/skin/frontend/ma_vanese/fahasa/images//footer/twitter-on.png">
                                                    </a>

                                                </div>
                                                <div class="col-sm-12 col-md-12 col-xs-12" style="font-size: 14.5px">
                                                    <div class="col-sm-6 col-md-6 col-xs-6" style="text-align: right;">
                                                        <a href="javascript:void(0)">
                                                            <img alt="Bookstore.COM" src="https://www.fahasa.com/media/wysiwyg/Logo-NCC/android.png" style="max-width: 110px;">
                                                        </a>
                                                    </div>
                                                    <div class="col-sm-6 col-md-6 col-xs-6">
                                                        <a href="javascript:void(0)"> <img alt="Bookstore.COM" src="https://www.fahasa.com/media/wysiwyg/Logo-NCC/appstore.png" style="max-width: 110px;">
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
