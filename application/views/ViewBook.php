								...
								<div class="thumbnail">
									<!-- <%
										...
										if (book != null && book instanceof Book) {
											...
											if (pathsImage != null) {
												pathImage = "<?php echo base_url()?>static/image/" + pathsImage.getDuongDan();
											}
										}
										out.println(
						...
						<!-- <%
							...
							if (bookTT != null && bookTT instanceof Book[]) {
								...
								for (int i = 0; i < bookTTs.length; i++) {
									...
									out.println("<a href=\"ViewBook?id=" + MaSach + "\"><li class=\"item\"><img src=\"<?php echo base_url()?>static/image/"
